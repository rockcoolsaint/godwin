                ...
                <div className="row">
                    <div className="col-md-3 col-sm-12">
                        <div className="foot-abt">
                            ...
                            <ul>
                                <li><Link to="#">Contact@mail.com</Link></li>
                                <li><Link to="#">+011123456789</Link></li>
                            </ul>

                            <div className="social-bx">
                                <Link to="#" target="_blank"><i className="fab fa-facebook-f fa-fw"></i></Link>
                                <Link to="#" target="_blank"><i className="fab fa-instagram fa-fw"></i></Link>
                                <Link to="#" target="_blank"><i className="fab fa-twitter fa-fw"></i></Link>
                                <Link to="#" target="_blank"><i className="fab fa-skype fa-fw"></i></Link>
                            </div>
                        </div>
                    </div>
