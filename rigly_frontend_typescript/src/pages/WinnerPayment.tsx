          ...
          <div id="content" className="content">
            ...
            <div className="content-banner">
              <p>
                ...
                <b>{((currentBid / 100) * auctionType).toFixed(2)}</b> sats
              </p>
            </div>
            ...
            <section className="paywall-content">
              ...
              <div className="similer-data">
                <Link
                  className="m-2 btn-main"
                  target="_blank"
                  to={"https://mempool.space/address/" + qrValue}
                >
                  <span>Verify your payment</span>
                </Link>
              </div>
              <div className="paywall-note">
                ...
                <div className="paywall-note-text">
                  This paywall requires Lightning. If you need a Lightning
                  wallet, check out
                  <Link
