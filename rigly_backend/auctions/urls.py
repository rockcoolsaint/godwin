...
urlpatterns = [
    path("detailed_auction_view/<int:auction_id>/", views.detailed_auction_view, name="detailed_auction_view")
    ...
    # path("test/", views.announce_winner_and_add_auction_resultsounce_winner_and_add_auction_results, name="start_auctions_and_check_auctions_expiry"),
]
