...
class AuctionMetaData(models.Model):
    profile_image_1 = models.FileField(upload_to='auction_profile_images', null=True, blank=True, max_length=800)
    profile_image_2 = models.FileField(upload_to='auction_profile_images', null=True, blank=True, max_length=800)
    profile_image_3 = models.FileField(upload_to='auction_profile_images', null=True, blank=True, max_length=800)
    site_photo = models.FileField(upload_to='auction_profile_images', null=True, blank=True, max_length=800)
    live_feed_image = models.FileField(upload_to='auction_profile_images', null=True, blank=True, max_length=800)
    hash_price_image = models.FileField(upload_to='auction_profile_images', null=True, blank=True, max_length=800)
...
class AuctionList(BaseModel):
    ...
    auction_type = models.ForeignKey(AuctionType, on_delete=models.CASCADE, blank=True, null=True)
    payment_address = models.CharField(max_length=500, blank=True, null=True)
    payment_address_qr = models.FileField(upload_to='payment_qr', null=True, blank=True, max_length=800)
    auction_meta = models.ForeignKey(AuctionMetaData, on_delete=models.CASCADE, null=True, blank=True)
