...
interface MiningLayoutProps {
  ...
  // For /learn/mining
const navigation = [
  { name: 'How Mining Works', href: '/learn/mining/how-mining-works' },
  { name: 'Hashrate Explained', href: '/learn/mining/hashrate-explained' },
  { name: 'Mining Pool Profiles', href: '/learn/mining/mining-pool-profiles' },
  { name: 'History of Mining', href: '/learn/mining/history-of-mining' },
  { name: 'Mining Difficulty', href: '/learn/mining/mining-difficulty' },
]

export default function MiningLayout({ children, navTitle }: MiningLayoutProps) {
