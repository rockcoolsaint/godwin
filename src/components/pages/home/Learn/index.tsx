        ...
        <div className="mx-auto max-w-6xl divide-gray-900/10">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="flex-1">
              <p className="text-3xl mb-8">Mining made easy.</p>
              <div className="space-y-6 divide-y divide-gray-900/10">
                <Disclosure as="div" className="pt-6" defaultOpen={false}>
                  {/* First disclosure - same content */}
                  {({ open }) => (
                    <>
                      <div>
                        <Disclosure.Button className="flex w-full items-start justify-between text-left text-gray-900">
                          <h2 className="text-lg font-semibold text-primary lg:text-2xl">What is the problem?</h2>
                ...
                <Disclosure as="div" className="pt-6" defaultOpen={false}>
                  {/* Second disclosure - same content */}
                  {({ open }) => (
                    <>
                      <div>
                        <Disclosure.Button className="flex w-full items-start justify-between text-left text-gray-900">
                          <h2 className="text-lg font-semibold text-primary lg:text-2xl">How does Rigly help?</h2>
            ...
            {/* Right column */}
            <div className="flex-1">
              <p className="text-3xl mb-8">Bitcoin-only marketplace.</p>
              <div className="space-y-6 divide-y divide-gray-900/10">
                <Disclosure as="div" className="pt-6" defaultOpen={false}>
                  {/* Third disclosure - same content */}
                  {({ open }) => (
                    <>
                      <div>
                        <Disclosure.Button className="flex w-full items-start justify-between text-left text-gray-900">
                          <h2 className="text-lg font-semibold text-primary lg:text-2xl">100% real hashrate</h2>
                          <span className="ml-6 flex h-7 items-center">
                            {open ? (
                              <ChevronUpIcon className="h-3 w-3 text-primary lg:h-5 lg:w-5" aria-hidden="true" />
                            ) : (
                ...
                <Disclosure as="div" className="pt-6" defaultOpen={false}>
                  {/* Fourth disclosure - same content */}
                  {({ open }) => (
                    <>
                      <div>
                        <Disclosure.Button className="flex w-full items-start justify-between text-left text-gray-900">
                          <h2 className="text-lg font-semibold text-primary lg:text-2xl">Reputation system</h2>
                          <span className="ml-6 flex h-7 items-center">
                            {open ? (
                              <ChevronUpIcon className="h-3 w-3 text-primary lg:h-5 lg:w-5" aria-hidden="true" />
                            ) : (
