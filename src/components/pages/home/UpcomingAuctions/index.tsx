  ...
  return (
    <>
      <div className="mx-auto flex flex-col items-center justify-center overflow-auto">
        <h1 className="mt-10 w-10/12 text-center font-chakra text-4xl text-navy lg:w-full lg:text-5xl 2xl:text-7xl">
          Auctions
        </h1>
        ...
        {/* Seller Boxes */}
        <div className="mt-10 mb-10 p-6 grid grid-cols-1 gap-8 lg:grid-cols-3">
